...
To pass the data you must create a object called  **OSSimpleCellData**
...
I believe the best way to show you is giving a example!

### Example

In this example we are creating multiple **Notifications Cells** and a **Comment Cell**

First, we're going to set our cell configuration, to do so we can create a separated class with the configs:
...
With the config methods we can set the cells layout! Now, we must pass the data to the cells, to do this we can create a method **inside our project models** that convers the properties for us.
